...
def tde_footprint(nside=32, u_boost=2.):
...
def gen_greedy_surveys(nside, nexp=1):
    ...
    """
    target_map = tde_footprint(nside=nside)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--illum_limit", type=float, default=75.)
    ...
    fileroot = 'tde_'+'illum%i_' % illum_limit
    file_end = 'v1.3_'
