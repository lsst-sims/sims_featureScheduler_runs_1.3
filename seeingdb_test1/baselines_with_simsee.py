...
def run_sched(surveys, survey_length=365.25, nside=32, fileroot='baseline_', verbose=False,
              extra_info=None, seeing_db=None):
    years = np.round(survey_length/365.25)
    scheduler = Core_scheduler(surveys, nside=nside)
    n_visit_limit = None
    observatory = Model_observatory(nside=nside, seeing_db=seeing_db)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--seeingDB", type=str, default="")
    parser.add_argument("--fileroot", type=str, default="baseline")
    ...
    seeing_db = args.seeingDB if len(args.seeingDB)>0 else None
    ...
    if Pairs:
        if mixedPairs:
            ...
            run_sched(surveys, survey_length=survey_length, verbose=verbose,
                      ...
                      nside=nside, seeing_db=seeing_db)
