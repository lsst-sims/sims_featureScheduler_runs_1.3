...
from lsst.sims.featureScheduler.utils import calc_norm_factor, create_season_offset
...
import os
import argparse
from footprints import wfd_only_fp
...
def generate_blobs(nside, nexp=1, no_pairs=False, offset=None, template_weight=6.):
    target_map = wfd_only_fp(nside=nside)
    norm_factor = calc_norm_factor(target_map)
